 ...
 *
 */ 
public class TouchGifView extends /*ImageView*/GifView
{
    public int left = 50;
    public int top= 50;
    public int right= 50;
    public int bottm= 50;
    public int selfchange = 2;
    
	public TouchGifView(Context context, AttributeSet attrs) {
		super(context, attrs);
    ...
    public TouchGifView(Context context,int w,int h) {
		super(context, null);
		this.setPadding(0, 0, 0, 0);
		screenW = w;
		screenH = h;
...
//	        	setLayoutParams(params);
    ...
    private void setPosition(int left,int top,int right,int bottom) {  
    	...
    	this.right = right;
    	this.bottm = bottom;
    	//System height: 1280 System width: 720
//    	D/zheng   (25985): left: 272top: 400right: 448bottom: 620
//    	D/zheng   (25985): width: 176 height: 220
    }
